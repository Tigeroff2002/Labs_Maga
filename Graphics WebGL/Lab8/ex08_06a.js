...
function init(){
	...
	var body_geometry = new THREE.SphereGeometry( 40, 70, 70);
	var eyeball_material=new THREE.MeshLambertMaterial( { color: 0xFFFFFF } );
	var eyeball_geometry = new THREE.SphereGeometry( 20, 32, 32);
	var mouth_material=new THREE.MeshLambertMaterial( { color: 0xFF9999 } );
	var mouth_geometry = new THREE.SphereGeometry( 5, 32, 32);
	var noise_material=new THREE.MeshLambertMaterial( { color: 0xFFDDAA } );
	var noise_geometry = new THREE.SphereGeometry( 8, 32, 32);
	...
	body.position.set( 0, -20, -25 );

	mouth = new THREE.Mesh( mouth_geometry, mouth_material);
	mouth.position.set( 0, -40, 25 );

	noise = new THREE.Mesh( noise_geometry, noise_material);
	noise.position.set( 0, -20, 25 );
	...
	scene.add( light1, light2, body, eyeball_left, eyeball_right, mouth, noise );
}
